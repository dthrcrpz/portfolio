...
<script>
  ...
  onMount(() => {
    ...
    ScrollReveal().reveal('.blog-banner h1', { delay: 200, duration: 1000, origin: 'left' })
    ScrollReveal().reveal('.blog-banner p', { delay: 300, duration: 1000, origin: 'left' })

    ScrollReveal().reveal('.page-blogs .box', { delay: 200, duration: 1000, interval: 200, origin: 'left' })

    ScrollReveal().reveal('.breadcrumbs li', { delay: 200, duration: 1000, interval: 200, origin: 'left' })
    ScrollReveal().reveal('.breadcrumbs span', { delay: 200, duration: 1000, interval: 200, origin: 'left' })

    ScrollReveal().reveal('.page-blogs .content', { delay: 200, duration: 1000, origin: 'bottom' })
