<section class="about relative rounded-b-3xl overflow-hidden">
  <svg class="absolute left-0 right-0 top-0 bottom-0 opacity-10 xl:w-full xl:h-full" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="1440" height="560" preserveAspectRatio="none" viewBox="0 0 1440 560">
    <g mask="url(&quot;#SvgjsMask1185&quot;)" fill="none">
      ...
      <path d="M -268.9188462764992,312 C -196.92,258.4 -52.92,18.6 91.08115372350078,44 C 235.08,69.4 307.08,419.4 451.0811537235008,439 C 595.08,458.6 667.08,150 811.0811537235007,142 C 955.08,134 1027.08,396.2 1171.0811537235008,399 C 1315.08,401.8 1477.3,174.2 1531.0811537235008,156 C 1584.86,137.8 1458.22,277.6 1440,308" class="stroke-dark dark:stroke-primary transition-colors duration-300" stroke-width="2"></path>
      <path d="M -474.2332847208804,131 C -402.23,201.4 -258.23,461.6 -114.23328472088039,483 C 29.77,504.4 101.77,268 245.7667152791196,238 C 389.77,208 461.77,375.4 605.7667152791196,333 C 749.77,290.6 821.77,35.6 965.7667152791196,26 C 1109.77,16.4 1230.92,287.2 1325.7667152791196,285 C 1420.61,282.8 1417.15,69 1440,15" class="stroke-dark dark:stroke-primary transition-colors duration-300" stroke-width="2"></path>
      <path d="M -594.8184711531194,294 C -522.82,250.8 -378.82,79.4 -234.81847115311936,78 C -90.82,76.6 -18.82,294 125.18152884688064,287 C 269.18,280 341.18,0.4 485.1815288468806,43 C 629.18,85.6 701.18,503.2 845.1815288468806,500 C 989.18,496.8 1086.22,40.4 1205.1815288468806,27 C 1324.15,13.6 1393.04,351.8 1440,433" class="stroke-dark dark:stroke-primary transition-colors duration-300" stroke-width="2"></path>
    </g>
    <defs>
      <mask id="SvgjsMask1185">
    ...
    <div class="flex flex-row flex-wrap justify-center mt-10">
      ...
      <div class="box w-full xl:w-1/3 px-0 md:px-3 py-3">
        <div class="h-full transition-all bg-white dark:bg-dark duration-300 rounded-2xl px-5 py-10 shadow-[0px_1px_8px_0px_#00000020] dark:shadow-[0px_1px_8px_0px_#06b6d430]">
          <div class="flex flex-row items-start flex-grow-0">
            <div class="w-[50px] mr-5 flex-shrink-0">
              <svg class="w-full fill-tertiary" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24"><path d="M12 5c3.453 0 5.891 2.797 5.567 6.78 1.745-.046 4.433.751 4.433 3.72 0 1.93-1.57 3.5-3.5 3.5h-13c-1.93 0-3.5-1.57-3.5-3.5 0-2.797 2.479-3.833 4.433-3.72-.167-4.218 2.208-6.78 5.567-6.78zm0-2c-4.006 0-7.267 3.141-7.479 7.092-2.57.463-4.521 2.706-4.521 5.408 0 3.037 2.463 5.5 5.5 5.5h13c3.037 0 5.5-2.463 5.5-5.5 0-2.702-1.951-4.945-4.521-5.408-.212-3.951-3.473-7.092-7.479-7.092zm-1 14l-4-1.701v-1.599l4-1.7v1.567l-2.229.933 2.229.93v1.57zm2-5v1.567l2.229.933-2.229.93v1.57l4-1.701v-1.599l-4-1.7z"/></svg>
            </div>
            <div>
      ...
      <div class="box w-full xl:w-1/3 px-0 md:px-3 py-3">
        <div class="h-full transition-all bg-white dark:bg-dark duration-300 rounded-2xl px-5 py-10 shadow-[0px_1px_8px_0px_#00000020] dark:shadow-[0px_1px_8px_0px_#06b6d430]">
          <div class="flex flex-row items-start flex-grow-0">
            <div class="w-[50px] mr-5 flex-shrink-0">
              <svg class="w-full fill-tertiary" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24"><path d="M9.602 3.7c-1.154 1.937-.635 5.227 1.424 9.025.93 1.712.697 3.02.338 3.815-.982 2.178-3.675 2.799-6.525 3.456-1.964.454-1.839.87-1.839 4.004h-1.995l-.005-1.241c0-2.52.199-3.975 3.178-4.663 3.365-.777 6.688-1.473 5.09-4.418-4.733-8.729-1.35-13.678 3.732-13.678 3.321 0 5.97 2.117 5.97 6.167 0 3.555-1.949 6.833-2.383 7.833h-2.115c.392-1.536 2.499-4.366 2.499-7.842 0-5.153-5.867-4.985-7.369-2.458zm13.398 15.3h-8v2h8v-2z"/></svg>
            </div>
            <div>
